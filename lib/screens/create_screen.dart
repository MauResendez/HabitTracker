...
class _CreateScreenState extends State<CreateScreen> 
{
  ...
  createHabit() 
  {
    ...
    if (formKey.currentState.validate()) 
    {
      ...
      if(habitTitle.isNotEmpty && (monday || tuesday || wednesday || thursday || friday || saturday || sunday))
      {
  ...
  onSaveStartTime() async
  {
    ...
    if(timeGetter != null) // If cancel button isn't pressed or isn't pressed outside of timepicker, set the start time
    {
  ...
  Widget errorMessage(bool err)
  {
    if(err == true)
    {
      ...
      (
        ...
        child: Text("One or more fields are incomplete", style: TextStyle(fontSize: 17, color: Colors.red)),
      );
    }
