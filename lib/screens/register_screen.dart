                  ...
                  (
                    ...
                    [
                      ...
                      (
                        ...
                        validator: (input) => !isAlphanumeric(input) || !input.isNotEmpty ? 'Please enter a valid username' : null, 
                      ...
                      FlatButton(onPressed: submit, color: Colors.red, child: Text("Register", style: TextStyle(color: Colors.white, fontSize: 17),)),
                      Padding
                      (
                        padding: const EdgeInsets.only(top: 10),
                        child: GestureDetector(onTap: () => Navigator.pop(context), child: Text("Already signed up, log in here")),
                      )
                    ],
                  ),
                ),
